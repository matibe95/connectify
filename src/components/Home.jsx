  ...
  return (
    ...
    <section className='bg-c-yellow relative custom-container py-8 px-4 flex flex-col gap-8 items-center mb-6'>
        ...
        <div className='flex gap-4 main-buttons-container text-center'>
          <a href="/Aqui va tu nombre" className='px-4 py-3 font-bold custom-container-without-border primary-animation bg-c-primary text-c-light'>Comenzar</a>
        ...
        <svg className='animate-spin-slow main-icon fill-c-red transition-all' width="120" height="120" viewBox="0 0 197 195" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className='animate-spin-slow absolute main-icon-triangle fill-c-blue transition-all' width="189" height="180" viewBox="0 0 189 180" fill="none" xmlns="http://www.w3.org/2000/svg">
